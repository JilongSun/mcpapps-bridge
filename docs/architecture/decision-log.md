...
| [0003](decisions/0003-mcp-apps-gateway-and-optional-agent-host.md) | Accepted; amended by 0008, 0010, 0011, 0014, and 0015 | Partial | Gateway data plane, read-only management, and the first provider-neutral text-run/OpenAI slice exist; MCP Apps host workflows and complete Agent Host behavior remain incomplete |
...
| [0010](decisions/0010-application-contexts-and-capability-composition.md) | Accepted; amended by 0011, 0012, 0013, 0014, and 0015 | Partial | Gateway, Agent Host, and MCP Apps widget lifecycle are separated inside one service package; Host actions remain pending |
| [0011](decisions/0011-single-agent-target-and-endpoint-assignment.md) | Accepted; amended by 0012, 0014, and 0015 | Partial | Single Target identity, exclusive endpoint ownership validation, one-active-Run coordination, operation attribution, management assignment exposure, and reusable Hermes runtime are implemented |
...
| [0015](decisions/0015-agent-host-runs-and-mcp-apps-endpoint-composition.md) | Accepted | Partial | Endpoint ownership, Run correlation, fresh resource reads, and MCP Apps widget lifecycle are implemented; Host event composition remains pending |
