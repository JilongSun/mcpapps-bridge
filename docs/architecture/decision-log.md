...
| --- | --- | --- | --- |
| [0001](decisions/0001-managed-endpoints-and-session-ownership.md) | Accepted; amended by 0003, 0008, 0013, and 0014 | Partial | Managed topology, core-owned endpoint dispatch, and isolated sessions exist; v0.1 management is read-only |
| [0002](decisions/0002-sqlite-persistence-and-configuration-authority.md) | Accepted; amended by 0008, 0013, and 0014 | Partial | SQLite, reset migrations, revisions, events, and bootstrap exist; v0.1 topology is frozen after seed |
| [0003](decisions/0003-mcp-apps-gateway-and-optional-agent-host.md) | Accepted; amended by 0008, 0010, 0011, and 0014 | Partial | Gateway data plane and the first provider-neutral text-run/OpenAI slice exist; read-only management, MCP Apps host workflows, and complete Agent Host behavior remain incomplete |
| [0004](decisions/0004-first-release-scope-and-distribution.md) | Accepted; amended by 0008 and 0014 | Partial | The gateway foundation is implemented; read-only management/inspection, Agent Host, and OCI delivery remain release blockers |
...
| [0011](decisions/0011-single-agent-target-and-endpoint-assignment.md) | Accepted; amended by 0012 and 0014 | Partial | Single Target identity, canonical OpenAI model list, endpoint validation, and reusable Hermes runtime are implemented; endpoint-path exposure remains pending |
...
| [0014](decisions/0014-read-only-v0-1-management-plane.md) | Accepted | Partial | v0.1 exposes read-only topology, status, readiness, and session inspection while topology mutations move beyond v0.1 |
...
- Read-only topology, status, readiness, and session-inspection HTTP APIs.
- Agent Target management/readiness exposure and stable endpoint-path guidance.
...
resource. Transcript input/output, host-owned MCP App actions, read-only topology/status workflows,
and complete connection inspection remain pending or partial. Writable topology management is no
longer part of v0.1 under ADR 0014.
