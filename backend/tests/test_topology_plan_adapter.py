...
from mcpapps_bridge.mcp.plan_adapter import endpoint_plan_from_revision


def test_current_revision_adapts_to_core_plan_with_immutable_revision_keys() -> None:
    ...
    plan = endpoint_plan_from_revision(revision)
