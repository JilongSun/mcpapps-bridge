"""SQLite event log and snapshot projection store for Gateway session inspection.

Stored JSON uses application-owned event and snapshot contracts. This adapter owns transaction
serialization and waiter notification, while projection semantics stay in the application layer.
"""
